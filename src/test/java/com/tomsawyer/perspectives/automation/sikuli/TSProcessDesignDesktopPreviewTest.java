...
public class TSProcessDesignDesktopPreviewTest
{
	@BeforeClass
	...
	public void testIsActionsTreeViewPresent()
	{
		...
		Assert.assertTrue(desktopTester.testIsTreeViewPresent(actionsTreeViewTab, actionsTreeViewExpected, defaultTreeViewTab));
	...
	public void testInspectorView()
	{
		...
		Assert.assertTrue(desktopTester.testIsInspectorViewPresent(nodeSelected, inspectorViewExpected));
	}
	
	@Test
	public void testDefaultButtonsState()
	{
		Assert.assertTrue(desktopTester.testProcessDesignButtonsState());	
	}
	@Test
	public void testSubProcessButtonsState()
	{
		Assert.assertTrue(desktopTester.testProcessDesignButtonStateSubProcess());
