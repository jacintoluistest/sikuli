...
public class TSShortestPathsHtml5PreviewTest
{
	@BeforeClass
	public static void setUp()
	{
		       // org.sikuli.basics.Debug.setDebugLevel(3);
				...
				environment =
					new TSEnvironment("ShortestPaths", TSEnvironment.HTML5_PREVIEW, defaultBrowser);
				TSAutomationTester = new TSTester(defaultBrowser);
				html5Tester =
					new TSHtml5PreviewTestCases(environment, TSAutomationTester, className);
				TSAutomationTester =
					TSFunctions.setHtml5Test(TSAutomationTester, "ShortestPathsProjectPath");
	...
	{
		Assert.assertTrue(html5Tester.testOnMouseHoverSetStartNode());
	}
	
	@Test
	public void testOnMouseHoverSetFinishNode()
	{
		Assert.assertTrue(html5Tester.testOnMouseHoverSetFinishNode());
	}
	
	@Test
	public void testOnMouseHoverRunShortestPaths()
	{
		Assert.assertTrue(html5Tester.testOnMouseHoverRunShortestPaths());
	}
	...
	{
		Assert.assertTrue(html5Tester.testShortestPathsButtonsState());
	}
	
	@Test
	public void testRunShortestPathsAlgorithm()
	{
		Assert.assertTrue(html5Tester.runShortestPathsAlgorithm());
	}
	...
	{
		Assert.assertTrue(html5Tester.testSymmetricLayoutSelected());
	}
