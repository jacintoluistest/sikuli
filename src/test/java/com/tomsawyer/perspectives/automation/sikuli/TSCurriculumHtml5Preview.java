...
public class TSCurriculumHtml5Preview
{
	@BeforeClass
	...
	public void testIsInspectorViewPresent()
	{
		...
		Assert.assertTrue(html5Tester.testIsInspectorViewPresentCurriculum());
	}
	
	@Test
	public void testIsOpenWebPageEnabled()
	{
		Assert.assertTrue(html5Tester.testIsOpenWebPageEnabledCurriculum());
	}
