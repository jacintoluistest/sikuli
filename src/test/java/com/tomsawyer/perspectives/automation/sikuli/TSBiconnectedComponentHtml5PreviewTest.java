...
public class TSBiconnectedComponentHtml5PreviewTest
{
	@BeforeClass
	...
	@Test
	public void testOnMouseHoverRunBiconnected()
	{
		Assert.assertTrue(html5Tester.testOnMouseHoverRunBiconnected());
	}
	...
	{
		String symmetricToolBar = environment.toolBarImagesPath + File.separator + "SymmetricSelectedLayoutCanvas.png";
		Assert.assertTrue(html5Tester.testSymmetricLayout(symmetricToolBar));
	}
